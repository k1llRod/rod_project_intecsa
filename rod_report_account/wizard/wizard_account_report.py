...
class WizardAccountReport(models.TransientModel):
    ...
    def generate_pdf_report(self):
        ...
        return self.env.ref('rod_account_coa.custom_pdf_report').with_context(context).report_action(self, data=context)
    ...
    def report_account_move_line(self):
        ...
        return self.env.ref('rod_report_account.account_move_line_pdf_report').report_action(self, data=data)
    ...
    def report_sums_balances(self):
        ...
        return self.env.ref('rod_report_account.report_sums_balances').report_action(self, data=data)